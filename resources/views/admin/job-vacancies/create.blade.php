...
@section('content')
<div class="max-w-3xl mx-auto space-y-6" x-data="jobVacancyForm()">
    ...
    <form action="{{ route('admin.job-vacancies.store') }}" method="POST" class="bg-neutral-900 border border-neutral-800 p-6 md:p-8 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('title') }}" 
                       required 
                       placeholder="e.g. Lead Cryogenic Process Engineer" 
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('slug') }}" 
                       placeholder="lead-cryogenic-process-engineer" 
                       class="w-full bg-neutral-950 border border-neutral-800 text-white text-xs px-4 py-3 focus:outline-none focus:border-white transition-colors">
                <div class="flex items-center justify-between text-[10px] text-neutral-500 mt-1">
                    <span>Otomatis dari posisi pekerjaan.</span>
        ...
        <div>
            ...
            <input type="text" 
                   ...
                   placeholder="e.g. Application - Lead Cryogenic Engineer - [Your Name]" 
                   class="w-full bg-neutral-950 border border-neutral-800 text-white text-xs px-4 py-3 focus:outline-none focus:border-white transition-colors">
        </div>
        ...
        <div>
            ...
            <textarea id="requirements" 
                      name="requirements" 
                      rows="5" 
                      placeholder="Bachelor's degree in Chemical or Mechanical Engineering&#10;Minimum 5+ years proven experience in LNG/Oil &amp; Gas facilities&#10;Proficiency in Aspen HYSYS / Process Simulation" 
